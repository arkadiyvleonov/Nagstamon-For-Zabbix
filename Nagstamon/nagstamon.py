...
try:
    ...
    paths_to_check = [normcase(join(os.getcwd(), "resources")),
    ...
    try:
        ...
        paths_to_check.append(normcase(join(get_python_lib(), "resources")))
    except:
        pass
    ...
    try:
        ...
        paths_to_check.append(normcase(join(site.USER_SITE, "resources")))
    except:
        pass

    # add directory nagstamon.py where nagstamon.py resides for cases like 0install without installed pkg-resources
    paths_to_check.append(os.sep.join(sys.argv[0].split(os.sep)[:-1] + ["resources"]))
